...
- **Knowledge Prerequisite:** Python and deep learning knowledge (Tensorflow/PyTorch).
- **Difficulty rating:** medium
- **Expected results:** new autonomous driving deep learning models optimized with lower inference time.
- **Expected length:** 175h
...
- **Knowledge Prerequisite:** Python and deep learning knowledge (specially PyTorch).
