...
<br>Web-templates consist of the use of the web browser as the user interface. The browser connects with the Docker image application in order to run the simulation and to allow the users to send their code and see the results of the simulation.
