...
youtubeId40: 4yKM3EuEv_g
youtubeId41: W3XirsadmNg
youtubeId50: W3XirsadmNg
...
## Project #4: Robotics-Academy: exercise on Deep Learning for Visual Detection
...
|    **Project**   |     [#1](https://jderobot.github.io/activities/gsoc/2020#project-1-robotics-academy-new-computer-vision-exercises)     |      [#2](https://jderobot.github.io/activities/gsoc/2020#project-2-robotics-academy-multirobot-version-of-the-amazon-warehouse-exercise-in-ros2)      |     [#3](https://jderobot.github.io/activities/gsoc/2020#project-3-robotics-academy-robotic-arm-manipulation-with-moveit)     |     [#4](https://jderobot.github.io/activities/gsoc/2020#project-4-robotics-academy-exercises-on-evolutionary-robotics)     |     [#5](https://jderobot.github.io/activities/gsoc/2020#project-5-improving-visualstates-tool-with-ros2-support-and-web-based-gui)     |     [#6](https://jderobot.github.io/activities/gsoc/2020#project-6-python-robot-applications-in-the-web-browser-extending-the-pyonbrowser-converter-to-js)     |     [#7](https://jderobot.github.io/activities/gsoc/2020#project-7-visualcircuit-tool-digital-electronics-language-for-robot-behaviors)     |     [#8](https://jderobot.github.io/activities/gsoc/2020#project-8-reinforcement-learning-for-autonomous-driving-with-gazebo-and-openai-gym)     |     [#9](https://jderobot.github.io/activities/gsoc/2020#project-8-reinforcement-learning-for-autonomous-driving-with-gazebo-and-openai-gym)     |     [#10](https://jderobot.github.io/activities/gsoc/2021#project-10-robotics-academy-new-drone-based-exercises)    |
| **Academy (A)** |     X     |     X     |     X     |     X     |     X     |     X     |     X     |     X     |     *     |     X     |
|    **C++ (B)**   |     O     |     X     |     O     |     X     |     X     |     O     |     O     |     X     |     *     |     O     |
